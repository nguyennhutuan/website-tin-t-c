...
class PagesController extends Controller
{
	...
	function trangchu()
	{
		...
		// $theloai = TheLoai::all();
		return view('pages.trangchu',['tintuc'=>$tintuc,'tinnoibat'=>$tinnoibat,'tintuclq1'=>$tintuclq1,'tintuclq2'=>$tintuclq2,'tintuclq3'=>$tintuclq3,'loaitin'=>$loaitin]); //['theloai'=>$theloai]);
	}
