...
<div id="outer-wrapper">
  ...
  <div id="single_post_container">
    @foreach($tintuc as $tt)
      <div class="post_single" style="width:140%">
      <h4 class="post_title clearfix" style="line-height: 35px; margin-bottom:0px"><a href="tintuc/{{$tt->id}}/{{$tt->TieuDeKhongDau}}.html">{{ $tt->TieuDe }}</a><span class="comment_bubble"><a href="#">{{ count($tt->comment) }}</a></span></h4>
        <div class="post_content clearfix">
          <div class="thumbnail"> <a href="tintuc/{{$tt->id}}/{{$tt->TieuDeKhongDau}}.html"><img style="width: 100px; height: 100px;" src="upload/tintuc/{{ $tt->Hinh }}" alt="" /></a></div>
          <div class="summary_article"><p style="width:800px">{{ $tt->TomTat }} </p></div>
        </div>
