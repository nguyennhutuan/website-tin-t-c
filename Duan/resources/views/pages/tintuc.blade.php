            ...
            <div id="entry">
                <div class="entry-content">
                    ...
                    <div class="social_sharing_post"> 
                        <a href="https://twitter.com/intent/tweet?url={{url()->current()}}" class="twitter"> Twitter</a> 
                        <a href="http://www.facebook.com/sharer.php?u={{url()->current()}}" class="facebook">Facebook</a> 
                    </div>
                </div>
