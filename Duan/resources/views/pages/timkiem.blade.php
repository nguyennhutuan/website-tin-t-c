...
<div id="content-wrapper">
    <div id="inner-content">
        <?php
            function doimau($str, $tukhoa) //str=văn bản muốn đổi màu, $tukhoa=từ khóa muốn nó đổi màu
            {
            ...
            <div id="single_post_container">
                ...
                <div class="post_single">
                    <h4 class="post_title clearfix"><a href="tintuc/{{$tt->id}}/{{$tt->TieuDeKhongDau}}.html">{!! doimau($tt->TieuDe, $tukhoa) !!}</a><span class="comment_bubble"><a href="#">{{ count($tt->comment) }}</a></span></h4>
